...
+ `BL = gmm(y = phenotype, gen = genotype, model = "BLASSO")`

**g. Model Average**

+ `MA = ben(y = phenotype, gen = genotype, model = "Average")`

**h. GBLUP**

+ `LK = ben(y = phenotype, gen = genotype, model = "GBLUP")`

**i. Reproducing Kernel Hilbert Spaces**

+ `GK = ben(y = phenotype, gen = genotype, model = "RKHS")`

**j. Random Forest**

+ `RF = ben(y = phenotype, gen = genotype, model = "RF")`

**k. Bayesian Shrinkage Regression**

+ `VS = emBA(y = phenotype, gen = genotype)`

**l. Bayesian Variable Selection**

+ `VS = emBB(y = phenotype, gen = genotype)`

**m. Mixture**

+ `MM = emBC(y = phenotype, gen = genotype)`

**n. GSRU Ridge Regression**

+ `RR = emRR(y = phenotype, gen = genotype)`

**o. Laplace Variable Selection**

+ `LV = emBL(y = phenotype, gen = genotype)`
